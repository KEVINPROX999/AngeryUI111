-- Bundled UI Library (single-file)
-- Generated: 2025-08-30T11:43:51
-- Root: Src

local __modules = {}
local __cache = {}
local __node_index = {}  -- path -> node

-- tiny virtual ModuleScript tree to support script.Parent/WaitForChild patterns
local function makeNode(name, parent, path)
  local node = { Name = name, Parent = parent, Children = {}, __path = path }
  local mt = {}
  mt.__index = {
    FindFirstChild = function(self, childName) return self.Children[childName] end,
    WaitForChild = function(self, childName)
      local c = self.Children[childName]
      if not c then error("WaitForChild failed: "..childName.." under "..self.__path) end
      return c
    end,
  }
  setmetatable(node, mt)
  __node_index[path] = node
  -- also register dotted alias
  __node_index[(path:gsub('/', '.'))] = node
  return node
end

local __root = makeNode('Src', nil, 'Src')

local function ensureNode(path)
  local current = __root
  local full = 'Src'
  for seg in (path):gmatch('[^/]+') do
    if seg ~= 'Src' then
      if not current.Children[seg] then
        local newPath = full .. '/' .. seg
        current.Children[seg] = makeNode(seg, current, newPath)
      end
...
-- custom require that accepts our nodes or string keys
local function __require(target)
  local key
  if type(target) == 'table' and target.__path then
    -- if target is a folder-like node, try its 'init' child
    local node = target
    if __modules[node.__path] then
      key = node.__path
    elseif node.Children['init'] and __modules[node.Children['init'].__path] then
      key = node.Children['init'].__path
    else
      key = node.__path  -- hope there is a module at this path
    end
  elseif type(target) == 'string' then
    key = target
  else
    error('Unsupported require target: '..tostring(target))
  end
  if __cache[key] ~= nil then return __cache[key] end
  local loader = __modules[key] or __modules[key:gsub('%.', '/')]
  if not loader then error('Module not found: '..tostring(key)) end
  local node = __node_index[key] or __node_index[key:gsub('%.', '/')]
  local result = loader(node)
  __cache[key] = result
  return result
end

-- build nodes for every module path
do
  ensureNode('Src/init')
  ensureNode('Src/Components/Assets')
  ensureNode('Src/Components/Button')
  ensureNode('Src/Components/Dialog')
  ensureNode('Src/Components/Element')
  ensureNode('Src/Components/Notification')
  ensureNode('Src/Components/Section')
  ensureNode('Src/Components/Tab')
  ensureNode('Src/Components/Textbox')
  ensureNode('Src/Components/TitleBar')
  ensureNode('Src/Components/Window')
  ensureNode('Src/Elements/Button')
  ensureNode('Src/Elements/Colorpicker')
  ensureNode('Src/Elements/Dropdown')
  ensureNode('Src/Elements/init')
  ensureNode('Src/Elements/Input')
  ensureNode('Src/Elements/Keybind')
  ensureNode('Src/Elements/Paragraph')
  ensureNode('Src/Elements/Slider')
  ensureNode('Src/Elements/Toggle')
  ensureNode('Src/Modules/Creator')
  ensureNode('Src/Modules/Acrylic/AcrylicBlur')
  ensureNode('Src/Modules/Acrylic/AcrylicPaint')
  ensureNode('Src/Modules/Acrylic/CreateAcrylic')
  ensureNode('Src/Modules/Acrylic/init')
  ensureNode('Src/Modules/Acrylic/Utils')
  ensureNode('Src/Themes/Abyss')
  ensureNode('Src/Themes/Adapta Nokto')
  ensureNode('Src/Themes/Ambiance')
  ensureNode('Src/Themes/Amethyst Dark')
  ensureNode('Src/Themes/Amethyst')
  ensureNode('Src/Themes/Aqua')
  ensureNode('Src/Themes/Arc Dark')
  ensureNode('Src/Themes/Dark Typewriter')
  ensureNode('Src/Themes/Dark')
  ensureNode('Src/Themes/Darker')
  ensureNode('Src/Themes/DuoTone Dark Earth')
  ensureNode('Src/Themes/DuoTone Dark Forest')
  ensureNode('Src/Themes/DuoTone Dark Sea')
  ensureNode('Src/Themes/DuoTone Dark Sky')
  ensureNode('Src/Themes/DuoTone Dark Space')
  ensureNode('Src/Themes/Elementary')
  ensureNode('Src/Themes/GitHub Dark Colorblind')
  ensureNode('Src/Themes/GitHub Dark Default')
  ensureNode('Src/Themes/GitHub Dark Dimmed')
  ensureNode('Src/Themes/GitHub Dark High Contrast')
  ensureNode('Src/Themes/GitHub Dark')
  ensureNode('Src/Themes/GitHub Light Colorblind')
  ensureNode('Src/Themes/GitHub Light Default')
  ensureNode('Src/Themes/GitHub Light High Contrast')
  ensureNode('Src/Themes/GitHub Light')
  ensureNode('Src/Themes/init')
  ensureNode('Src/Themes/Kimbie Dark')
  ensureNode('Src/Themes/Light')
  ensureNode('Src/Themes/Monokai Classic')
  ensureNode('Src/Themes/Monokai Dimmed')
  ensureNode('Src/Themes/Monokai Vibrant')
  ensureNode('Src/Themes/Monokai')
  ensureNode('Src/Themes/Quiet Light')
  ensureNode('Src/Themes/Rose')
  ensureNode('Src/Themes/Solarized Dark')
  ensureNode('Src/Themes/Solarized Light')
  ensureNode('Src/Themes/Tomorrow Night Blue')
  ensureNode('Src/Themes/Typewriter')
  ensureNode('Src/Themes/United GNOME')
  ensureNode('Src/Themes/United Ubuntu')
  ensureNode('Src/Themes/Viow Arabian Mix')
  ensureNode('Src/Themes/Viow Arabian')
  ensureNode('Src/Themes/Viow Darker')
  ensureNode('Src/Themes/Viow Flat')
  ensureNode('Src/Themes/Viow Light')
  ensureNode('Src/Themes/Viow Mars')
  ensureNode('Src/Themes/Viow Neon')
  ensureNode('Src/Themes/VS Dark')
  ensureNode('Src/Themes/VS Light')
  ensureNode('Src/Themes/VSC Dark High Contrast')
  ensureNode('Src/Themes/VSC Dark Modern')
  ensureNode('Src/Themes/VSC Dark+')
  ensureNode('Src/Themes/VSC Light High Contrast')
  ensureNode('Src/Themes/VSC Light Modern')
  ensureNode('Src/Themes/VSC Light+')
  ensureNode('Src/Themes/VSC Red')
  ensureNode('Src/Themes/Vynixu')
  ensureNode('Src/Themes/Yaru Dark')
  ensureNode('Src/Themes/Yaru')
end

__modules['Src/init'] = function(__node)
  local script = __node
...
__modules['Src/Components/Assets'] = function(__node)
  local script = __node
  local require = __require
return { 
...
__modules['Src/Components/Button'] = function(__node)
  local script = __node
  local require = __require
...
__modules['Src/Components/Dialog'] = function(__node)
  local script = __node
  local require = __require
local Root = script.Parent.Parent
local Creator = require(Root.Modules.Creator)
...
__modules['Src/Components/Element'] = function(__node)
  local script = __node
  local require = __require
local Root = script.Parent.Parent
local Creator = require(Root.Modules.Creator)
...
__modules['Src/Components/Notification'] = function(__node)
  local script = __node
  local require = __require
local Root = script.Parent.Parent
...
__modules['Src/Components/Section'] = function(__node)
  local script = __node
  local require = __require
local Root = script.Parent.Parent
local Creator = require(Root.Modules.Creator)
...
__modules['Src/Components/Tab'] = function(__node)
  local script = __node
  local require = __require
local Root = script.Parent.Parent
local Flipper = require(Root.Packages.Flipper)
...
__modules['Src/Components/Textbox'] = function(__node)
  local script = __node
  local require = __require
...
__modules['Src/Components/TitleBar'] = function(__node)
  local script = __node
  local require = __require
local Root = script.Parent.Parent
local Creator = require(Root.Modules.Creator)
...
__modules['Src/Components/Window'] = function(__node)
  local script = __node
  local require = __require
...
__modules['Src/Elements/Button'] = function(__node)
  local script = __node
  local require = __require
local Root = script.Parent.Parent
local Creator = require(Root.Modules.Creator)
...
__modules['Src/Elements/Colorpicker'] = function(__node)
  local script = __node
  local require = __require
...
__modules['Src/Elements/Dropdown'] = function(__node)
  local script = __node
  local require = __require
...
__modules['Src/Elements/init'] = function(__node)
  local script = __node
  local require = __require
local Elements = {}
...
__modules['Src/Elements'] = function(__node)
  local script = __node
  local require = __require
local Elements = {}
...
__modules['Src/Elements/Input'] = function(__node)
  local script = __node
  local require = __require
local Root = script.Parent.Parent
local Creator = require(Root.Modules.Creator)
...
__modules['Src/Elements/Keybind'] = function(__node)
  local script = __node
  local require = __require
local UserInputService = game:GetService("UserInputService")
...
__modules['Src/Elements/Paragraph'] = function(__node)
  local script = __node
  local require = __require
local Root = script.Parent.Parent
local Components = Root.Components
...
__modules['Src/Elements/Slider'] = function(__node)
  local script = __node
  local require = __require
local UserInputService = game:GetService("UserInputService")
local Root = script.Parent.Parent
...
__modules['Src/Elements/Toggle'] = function(__node)
  local script = __node
  local require = __require
...
__modules['Src/Modules/Creator'] = function(__node)
  local script = __node
  local require = __require
local Root = script.Parent.Parent
local Themes = require(Root.Themes)
...
__modules['Src/Modules/Acrylic/AcrylicBlur'] = function(__node)
  local script = __node
  local require = __require
...
__modules['Src/Modules/Acrylic/AcrylicPaint'] = function(__node)
  local script = __node
  local require = __require
local Root = script.Parent.Parent.Parent
local Creator = require(Root.Modules.Creator)
...
__modules['Src/Modules/Acrylic/CreateAcrylic'] = function(__node)
  local script = __node
  local require = __require
local Root = script.Parent.Parent.Parent
local Creator = require(Root.Modules.Creator)
...
__modules['Src/Modules/Acrylic/init'] = function(__node)
  local script = __node
  local require = __require
local Acrylic = {
...
__modules['Src/Modules/Acrylic'] = function(__node)
  local script = __node
  local require = __require
local Acrylic = {
	AcrylicBlur = require(script.AcrylicBlur),
...
__modules['Src/Modules/Acrylic/Utils'] = function(__node)
  local script = __node
  local require = __require
...
__modules['Src/Themes/Abyss'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Adapta Nokto'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Ambiance'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Amethyst Dark'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Amethyst'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Aqua'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Arc Dark'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Dark Typewriter'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Dark'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Darker'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/DuoTone Dark Earth'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/DuoTone Dark Forest'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/DuoTone Dark Sea'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/DuoTone Dark Sky'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/DuoTone Dark Space'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Elementary'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/GitHub Dark Colorblind'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/GitHub Dark Default'] = function(__node)
  local script = __node
  local require = __require
return {
    Accent = Color3.fromHex("#1f6feb"),  -- focusBorder
...
__modules['Src/Themes/GitHub Dark Dimmed'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/GitHub Dark High Contrast'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/GitHub Dark'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/GitHub Light Colorblind'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/GitHub Light Default'] = function(__node)
  local script = __node
  local require = __require
return {
    Accent = Color3.fromHex("#0969da"), -- focusBorder
...
__modules['Src/Themes/GitHub Light High Contrast'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/GitHub Light'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/init'] = function(__node)
  local script = __node
  local require = __require
local Themes = {
	Names = {
...
__modules['Src/Themes'] = function(__node)
  local script = __node
  local require = __require
local Themes = {
	Names = {
...
__modules['Src/Themes/Kimbie Dark'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Light'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Monokai Classic'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Monokai Dimmed'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Monokai Vibrant'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Monokai'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Quiet Light'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Rose'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Solarized Dark'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Solarized Light'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Tomorrow Night Blue'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Typewriter'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/United GNOME'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/United Ubuntu'] = function(__node)
  local script = __node
  local require = __require
return {
    Accent = Color3.fromHex("#48b258"),
...
__modules['Src/Themes/Viow Arabian Mix'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Viow Arabian'] = function(__node)
  local script = __node
  local require = __require
return {
    Accent = Color3.fromHex("#7b36e2"),
...
__modules['Src/Themes/Viow Darker'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Viow Flat'] = function(__node)
  local script = __node
  local require = __require
return {
    Accent = Color3.fromHex("#165fb3"),
...
__modules['Src/Themes/Viow Light'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Viow Mars'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Viow Neon'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/VS Dark'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/VS Light'] = function(__node)
  local script = __node
  local require = __require
return {
    Accent = Color3.fromHex("#007ACC"), -- activityBarBadge.background
...
__modules['Src/Themes/VSC Dark High Contrast'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/VSC Dark Modern'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/VSC Dark+'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/VSC Light High Contrast'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/VSC Light Modern'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/VSC Light+'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/VSC Red'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Vynixu'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Yaru Dark'] = function(__node)
  local script = __node
  local require = __require
return {
...
__modules['Src/Themes/Yaru'] = function(__node)
  local script = __node
  local require = __require
return {
    Accent = Color3.fromHex("#e95420"),
...
-- return the entry module's value
